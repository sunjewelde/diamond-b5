  ...
  def perform(*args)
    ...
    #         #-----End_Create data table create for Table model-------------
	   ...
	   # elsif @latest_date != @oldest_date
          ...
          @weight03_diamond_group_all = diamond_ref.weight03.where(:date=> @last_updated_date_table..@latest_date)
          @weight04_diamond_group_all = diamond_ref.weight04.where(:date=> @last_updated_date_table..@latest_date)
          @weight05_diamond_group_all = diamond_ref.weight05.where(:date=> @last_updated_date_table..@latest_date)
          @weight06_diamond_group_all = diamond_ref.weight06.where(:date=> @last_updated_date_table..@latest_date)
          @weight07_diamond_group_all = diamond_ref.weight07.where(:date=> @last_updated_date_table..@latest_date)
          @weight08_diamond_group_all = diamond_ref.weight08.where(:date=> @last_updated_date_table..@latest_date)
          @weight09_diamond_group_all = diamond_ref.weight09.where(:date=> @last_updated_date_table..@latest_date)
          @weight10_diamond_group_all = diamond_ref.weight10.where(:date=> @last_updated_date_table..@latest_date)
          @weight12_diamond_group_all = diamond_ref.weight12.where(:date=> @last_updated_date_table..@latest_date)
          @weight15_diamond_group_all = diamond_ref.weight15.where(:date=> @last_updated_date_table..@latest_date)
          @weight18_diamond_group_all = diamond_ref.weight18.where(:date=> @last_updated_date_table..@latest_date)
          @weight20_diamond_group_all = diamond_ref.weight20.where(:date=> @last_updated_date_table..@latest_date)
          @weight30_diamond_group_all = diamond_ref.weight30.where(:date=> @last_updated_date_table..@latest_date)
          @weight40_diamond_group_all = diamond_ref.weight40.where(:date=> @last_updated_date_table..@latest_date)
