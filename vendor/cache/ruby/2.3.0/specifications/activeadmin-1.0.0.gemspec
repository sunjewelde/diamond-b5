...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<inherited_resources>, ["~> 1.7"])
      s.add_runtime_dependency(%q<jquery-rails>, [">= 0"])
      s.add_runtime_dependency(%q<jquery-ui-rails>, [">= 0"])
      s.add_runtime_dependency(%q<kaminari>, ["< 2.0", ">= 0.15"])
      s.add_runtime_dependency(%q<railties>, ["< 5.2", ">= 4.2"])
      ...
      s.add_dependency(%q<inherited_resources>, ["~> 1.7"])
      s.add_dependency(%q<jquery-rails>, [">= 0"])
      s.add_dependency(%q<jquery-ui-rails>, [">= 0"])
      s.add_dependency(%q<kaminari>, ["< 2.0", ">= 0.15"])
      s.add_dependency(%q<railties>, ["< 5.2", ">= 4.2"])
